...
if (!empty($filtro_cnpj)) {
    ...
    $where_conditions[] = "cpf_cnpj LIKE :cnpj";
...
<body>
                        ...
                        <tbody>
                            <?php foreach ($empresas as $empresa): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions">
                                            <a href="visualizar_empresa.php?id=<?= $empresa['id'] ?>" class="btn btn-info btn-sm" title="Visualizar">
                                                👁️
                                            </a>
                                            <a href="editar_empresa.php?id=<?= $empresa['id'] ?>" class="btn btn-warning btn-sm" title="Editar">
                                                ✏️
                                            </a>
                                        </div>
                                    </td>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Auto-submit do formulário quando selecionar status
            const filtroAtivo = document.getElementById('ativo');
            filtroAtivo.addEventListener('change', function() {
                if (this.value !== '') {
                    document.querySelector('.filters-form').submit();
                }
            });

            // Confirmação antes de limpar filtros (apenas se houver filtros aplicados)
